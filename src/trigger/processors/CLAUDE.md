...
- [day-classifier.ts](day-classifier.ts) — Claude call. Returns `DayClassification { label, depth_weight, day_tone_line }`. Reads last 7 days for historical smoothing. Feeds the Synthesizer as `dayContext` and the audio OPEN line. **Load-bearing.**
