...
- [utils.ts](utils.ts) — `computeReadTimeSeconds(briefing)` (200 WPM, hardcoded), `formatReadTime(seconds)`, `halvingProgress`, `flowMoveText/Url`. Powers the 3-Minute Contract display.
