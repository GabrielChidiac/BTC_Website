...
export function DailyDiffBanner({ dailyDiff }: { dailyDiff: DailyDiff }) {
  return (
    <section className="card-interactive mt-6 rounded-xl border-l-4 border-l-[var(--color-accent)] border border-[var(--color-border)] bg-[var(--color-bg-surface)] px-4 py-3">
