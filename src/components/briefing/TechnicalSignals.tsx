...
function rsiZone(rsi: number): { label: string; color: string } {
  if (rsi >= 70) return { label: "Might be overheated", color: "text-[var(--color-bearish)]" };
  if (rsi >= 60) return { label: "Running warm", color: "text-[var(--color-accent)]" };
  if (rsi >= 40) return { label: "Neutral zone", color: "text-[var(--color-text-secondary)]" };
  if (rsi >= 30) return { label: "Running cool", color: "text-[var(--color-accent)]" };
  return { label: "Might be undervalued", color: "text-[var(--color-bullish)]" };
}
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <div className="card-interactive rounded-xl border border-[var(--color-border)] bg-[var(--color-bg-elevated)] p-3 col-span-2">
          ...
          <div className="relative mt-2 h-1.5 w-full overflow-hidden rounded-full bg-[var(--color-border)]">
            <div className="absolute inset-y-0 left-0 w-[30%] bg-[var(--color-bullish-soft)] rounded-l-full" />
            <div className="absolute inset-y-0 right-0 w-[30%] bg-[var(--color-bearish-soft)] rounded-r-full" />
            <div
        ...
        <div className="card-interactive rounded-xl border border-[var(--color-border)] bg-[var(--color-bg-elevated)] p-3">
          ...
          <p className="mt-1 font-[family-name:var(--font-heading)] text-lg font-bold text-[var(--color-bullish)]">
        ...
        <div className="card-interactive rounded-xl border border-[var(--color-border)] bg-[var(--color-bg-elevated)] p-3">
          ...
          <p className="mt-1 font-[family-name:var(--font-heading)] text-lg font-bold text-[var(--color-bearish)]">
