  ...
  return (
    <section className="mt-10">
      ...
      <div className="grid grid-cols-2 gap-3">
        {/* RSI */}
        <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-bg-elevated)] p-4 col-span-2">
        ...
        {/* Signal summary */}
        <div className="col-span-2 rounded-xl border-l-4 border-l-[var(--color-accent)] border border-[var(--color-border)] bg-[var(--color-bg-surface)] px-4 py-3">
